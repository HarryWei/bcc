...
unsigned long long vm1_vcpu3_curr_ts = 0;
module_param(vm1_vcpu3_curr_ts, unsigned long long, 0664);
EXPORT_SYMBOL_GPL(vm1_vcpu3_curr_ts);
unsigned long long vm1_vcpu3_ts = 0;
module_param(vm1_vcpu3_ts, unsigned long long, 0664);
...
unsigned long long vm1_vcpu4_ts = 0;
module_param(vm1_vcpu4_ts, unsigned long long, 0664);
...
unsigned long long vm1_vcpu4_curr_ts = 0;
module_param(vm1_vcpu4_curr_ts, unsigned long long, 0664);
...
u64 vm1_vcpu5_ts = 0;
module_param(vm1_vcpu5_ts, u64, 0664);
...
u64 vm1_vcpu5_curr_ts = 0;
module_param(vm1_vcpu5_curr_ts, u64, 0664);
...
u64 vm1_vcpu6_ts = 0;
module_param(vm1_vcpu6_ts, u64, 0664);
...
u64 vm1_vcpu6_curr_ts = 0;
module_param(vm1_vcpu6_curr_ts, u64, 0664);
...
u64 vm1_vcpu7_ts = 0;
module_param(vm1_vcpu7_ts, u64, 0664);
...
u64 vm1_vcpu7_curr_ts = 0;
module_param(vm1_vcpu7_curr_ts, u64, 0664);
...
u64 vm1_vcpu8_ts = 0;
module_param(vm1_vcpu8_ts, u64, 0664);
...
u64 vm1_vcpu8_curr_ts = 0;
module_param(vm1_vcpu8_curr_ts, u64, 0664);
...
u64 vm1_vcpu9_ts = 0;
module_param(vm1_vcpu9_ts, u64, 0664);
...
u64 vm1_vcpu9_curr_ts = 0;
module_param(vm1_vcpu9_curr_ts, u64, 0664);
...
u64 vm1_vcpu10_ts = 0;
module_param(vm1_vcpu10_ts, u64, 0664);
...
u64 vm1_vcpu10_curr_ts = 0;
module_param(vm1_vcpu10_curr_ts, u64, 0664);
