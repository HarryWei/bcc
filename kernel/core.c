...
u64 vm1_vcpu2_curr_ts = 0;
module_param(vm1_vcpu2_curr_ts, u64, 0664);
EXPORT_SYMBOL_GPL(vm1_vcpu2_curr_ts);
//The last timeslice of this vCPU
u64 vm1_vcpu2_ts = 0;
module_param(vm1_vcpu2_ts, u64, 0664);
...
u64 vm1_vcpu3_curr_ts = 0;
module_param(vm1_vcpu3_curr_ts, u64, 0664);
EXPORT_SYMBOL_GPL(vm1_vcpu3_curr_ts);
u64 vm1_vcpu3_ts = 0;
module_param(vm1_vcpu3_ts, u64, 0664);
...
u64 vm1_vcpu4_ts = 0;
module_param(vm1_vcpu4_ts, u64, 0664);
...
u64 vm1_vcpu4_curr_ts = 0;
module_param(vm1_vcpu4_curr_ts, u64, 0664);
